...
findpath=findpath(MY_IP,MY_MAC)
...
if scansuccess==1:
    ...
    for res in results:
        ...
        if udp==1:
            ...
            #if hw_src!=None or hw_dst!=None:
            #    ruleconstructor.addRuleARP(hw_src,hw_dst,port_check,"#OUT_PORT",reachable)
            #print("TCP " + str(tcp) + " ICMP " + str(icmp) + " UDP " + str(udp))
            rev_hw_src=None
            rev_hw_dst=None
            rev_ip_src=None
            rev_ip_dst=None
        ...
        if proto_ports==0:
            if hw_src==None and hw_dst==None and ip_src==None and ip_dst==None and port_check==0:
                ...
                ruleconstructor.addRule(rev_hw_src,rev_hw_dst,rev_ip_src,rev_ip_dst,port_check,rev_orig_srcIP,rev_recv_srcIP,rev_orig_dstIP,rev_recv_dstIP,icmp,tcp,udp,"#OUT_PORT",None,None,reachable)
            #if hw_src!=None or hw_dst!=None:
                #ruleconstructor.addRuleARP(rev_hw_src,rev_hw_dst,port_check,"#OUT_PORT",reachable)


            #if reachable==1:
                #reverse rule
                #TODO: reverse rule is not correct!!!
                #ruleconstructor.addReverseRule(hw_dst,hw_src,ip_dst,ip_src,port_check,recv_srcIP,orig_srcIP,recv_dstIP,orig_dstIP,icmp,tcp,udp,"#OUT_PORT",reachable)
            #if hw_src!=None or hw_dst!=None:
                #ruleconstructor.addRuleARP(hw_src,hw_dst,port_check,"#OUT_PORT",reachable)
                #if reachable==1:
                    #reverse rule
                    #TODO: reverse rule is not correct!!!
                    #evaluate ARP rule construction
                    #ruleconstructor.addRuleARP(hw_dst,hw_src,port_check,"#OUT_PORT",reachable)
