...
-------------------------------------------------------------
```
sudo python main.py 10.0.0.2/32 TCP eth0 [80,100,250]
...
------- Test which TCP ports, using ports [80, 100, 250], are checked --------
Probing 10.0.0.2 - 00:00:00:00:00:02 with TCP source port 80 and destination port 80
Replied!
Probing 10.0.0.2 - 00:00:00:00:00:02 with TCP source port 80 and destination port 100
No Reply!
Probing 10.0.0.2 - 00:00:00:00:00:02 with TCP source port 80 and destination port 250
No Reply!
Probing 10.0.0.2 - 00:00:00:00:00:02 with TCP source port 100 and destination port 80
No Reply!
Probing 10.0.0.2 - 00:00:00:00:00:02 with TCP source port 100 and destination port 100
No Reply!
Probing 10.0.0.2 - 00:00:00:00:00:02 with TCP source port 100 and destination port 250
No Reply!
Probing 10.0.0.2 - 00:00:00:00:00:02 with TCP source port 250 and destination port 80
No Reply!
Probing 10.0.0.2 - 00:00:00:00:00:02 with TCP source port 250 and destination port 100
No Reply!
Probing 10.0.0.2 - 00:00:00:00:00:02 with TCP source port 250 and destination port 250
No Reply!
-------------------------------------------
...
Sending UDP packet to port 100 at 10.0.0.2 / 00:00:00:00:00:02
...
Check if host at 10.0.0.2 - 00:00:00:00:00:02 is reachable with src addresses 10.0.0.56 - 00:00:00:7b:7f:5f from port 80 to port 80
Spoof ARP cache at 10.0.0.2 from 10.0.0.56 to 00:00:00:00:00:01
Proactive approach is assumed since no response for fake addresses received
-------------------------------------------
------- Check if layer 3 routing is used --------
Check if host at 10.0.0.2 - 00:00:00:00:00:02 is reachable with src addresses 10.0.0.56 - 00:00:00:00:00:01 from port 80 to port 80
ARP req for fake IP src received!
Spoof ARP cache at 10.0.0.2 from 10.0.0.56 to 00:00:00:00:00:01
Check if host at 10.0.0.2 - 00:00:00:00:00:02 is reachable from 10.0.0.56 - 00:00:00:00:00:01 from port 80 to port 80
-------------------------------------------
------- Check if layer 2 routing is used --------
Check if host at 10.0.0.2 - 00:00:00:00:00:02 is reachable with src addresses 10.0.0.1 - 00:00:00:46:fe:86 from port 80 to port 80
Response to fake src MAC received!
Spoof ARP cache at 10.0.0.2 from 10.0.0.1 to 00:00:00:46:fe:86
...
match=type:tcp,udp,dl_dst:00:00:00:00:00:02,tp_src:80,tp_dst:80,nw_dst:10.0.0.2 actions=output:#OUT_PORT
match=type:tcp,udp,dl_dst:00:00:00:00:00:01,tp_src:80,tp_dst:80,nw_dst:10.0.0.1 actions=output:#OUT_PORT
